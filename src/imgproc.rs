...
impl Mat {
    ...
    pub fn canny(&self, threshold1: f32, threshold2: f32, aperture_size: i32) -> Self {
        let edges = Self::from_raw(self.inner);
        unsafe { cvCanny(self.inner, edges.inner, threshold1, threshold2, aperture_size); }
        edges
    }
